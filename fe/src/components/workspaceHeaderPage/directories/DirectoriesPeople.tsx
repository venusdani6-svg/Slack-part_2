  ...
  return (
    <>
      <div className="w-full h-full flex flex-col flex-1 min-h-0 ">
        ...
        <div className="h-[calc(100vh-250px)] flex flex-col items-center min-h-[60vh] overflow-y-scroll overflow-x-hidden sidebar-scroll">
          ...
          <div className="max-w-[100%] px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 grid grid-cols-5 gap-[20px]">
