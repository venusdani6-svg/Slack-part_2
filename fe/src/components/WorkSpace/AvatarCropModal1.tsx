                ...
                <>
                    ...
                    >
                        ...
                        <div className="px-6 py-5 relative">
                            <div className="relative w-full h-[340px] bg-[#1D1C1D] rounded-md overflow-hidden">
                                {image && (
                                    <Cropper
                                        image={image}
                                        crop={crop}
                            ...
                            {preview && (
                                <div className="absolute bottom-6 left-6 bg-white shadow-lg rounded-lg px-3 py-2 flex items-center gap-3">
                                    <img
                                        src={preview}
